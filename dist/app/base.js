...
class Base {
    ...
    constructor(broker, backend, queue = "celery") {
        this.conf = (0, conf_1.defaultConf)();
    ...
    get broker() {
        if (!this._broker) {
            this._broker = (0, brokers_1.newCeleryBroker)(this.conf.CELERY_BROKER, this.conf.CELERY_BROKER_OPTIONS, this.conf.CELERY_QUEUE);
        }
        return this._broker;
    }
    get backend() {
        if (!this._backend) {
            this._backend = (0, backends_1.newCeleryBackend)(this.conf.CELERY_BACKEND, this.conf.CELERY_BACKEND_OPTIONS);
        }
